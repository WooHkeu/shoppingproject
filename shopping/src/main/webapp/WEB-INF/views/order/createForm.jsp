...
<body>
	<div class="container">
		<h2>
			<img src="/svg/bag-heart-fill.svg" style='width: 30px'> 주문/결제
		</h2>
		<div class="row">
			...
			<figcaption style="margin-left: 20px">수량:${qty} size:${(size).split(",")[a.index]}</figcaption>
			</figure>
			</c:forEach> 
			</div>
			<h3>배송 정보</h3>
			...
			<ul class="list-group">
				<li class="list-group-item">결제수단 선텍:
					<input type="radio" class="btn-check" name="payment" value="신용카드" checked id="btn1">
	...
	<form id="oform" method="post">
		<input type="hidden" name="cno" value="${cno}"> <!-- 장바구니(cart)를 통해서 주문 -->
