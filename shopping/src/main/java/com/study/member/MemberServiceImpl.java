...
public class MemberServiceImpl implements MemberService {
  ...
  private MemberMapper mapper;
        ...
        @Override
        public MemberDTO findIdByMemberDTO(MemberDTO memberDTO) {
            return mapper.findId(memberDTO);
        }

        @Override
        public MemberDTO findPasswordByMemberDTO(MemberDTO memberDTO) {
        return mapper.findPassword(memberDTO);
    }

        @Override
        public int updatePasswordByPayload(MemberPayload payload) {
        return mapper.updatePassword(payload);
    }
